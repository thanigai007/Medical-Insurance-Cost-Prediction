...
if menu == "Introduction":
    ...
    st.markdown("""
    This project explores a dataset of individuals and their medical insurance charges.
    ...
    - **region_northwest / southeast / southwest**: Region dummy variables
    - **charges**: Insurance cost (target)
    
    The dashboard includes:
    - 📊 **EDA Section** with 18 detailed insights
    - 🤖 **Prediction Module** (under development or already implemented)
    """)
